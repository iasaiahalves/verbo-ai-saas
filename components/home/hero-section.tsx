...
export default function HeroSection() {
  return (
    <MotionSection
        ...
        className="">
          <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800">
            <Badge
              ...
              <Sparkles className="h-6 w-6 mr-2 text-rose-600 animate-pulse animate-gradient-x"/>
      ...
      <MotionH2
        variants={itemVariants}
        className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">Get a beautiful summary reel of the document in seconds</MotionH2>
