    ...
    <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xs border-t border-rose-500/10">
      <div className="flex justify-between items-center">
        <Button
          ...
          className={cn("rounded-full w-12 h-12 transition-all duration-200 bg-linear-to-br from-rose-500 to-rose-600 backdrop-blur-xs border border-rose-500/10",
          ...
          {Array.from({ length: totalSections }).map((_, index) => (
            <button
              ...
              className={cn(
                ...
                currentSection === index ? "bf-linear-to-r from-rose-500 to-rose-600" 
